...
# Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/35.0.1916.47 Safari/537.36

HEADER = 'Mozilla/5.0'
if sys.platform == "win32":
    HEADER = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64)'
elif sys.platform == "darwin":
    HEADER = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15)'
